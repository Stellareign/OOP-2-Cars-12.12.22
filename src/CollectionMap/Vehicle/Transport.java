...
public abstract class Transport implements Competing {
   ...
   // private Driver driver;
    ...
    public Transport(String brand, String model, double engineVolume, String transmission, Map<Transport, Mechanic> transportMechanicMap) {
...
//}
    ...
    public Transport setTransportMechanicMap(Map<Transport, Mechanic> transportMechanicMap) {
        this.transportMechanicMap = transportMechanicMap;
        return this;
    }
    ...
    public String toString() {
        return "Transport{" +
                ...
                ", tsType='" + tsType + '\'' +
                ", mechanics=" + transportMechanicMap +
                '}';
    }
