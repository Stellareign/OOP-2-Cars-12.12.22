...
public class CargoCar<C> extends Transport implements Drive, Competing {
    ...
    public CargoCar(String brand, String model, double engineVolume, String transmission, LoadCapacity loadCapacity, List<Mechanic> mechanics) {
